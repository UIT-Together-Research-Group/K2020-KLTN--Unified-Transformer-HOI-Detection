...
class HOTR(nn.Module):
    def __init__(self, detr,
        ...
        # ----------------------------------
        self.semantic_features_path = '/content/drive/MyDrive/Paper_UIT/HOTR/v-coco/semanticFeatures'
        # self.caption_feature_path = '/content/drive/MyDrive/Paper_UIT/HOTR/v-coco/captions_npy'
    ...
    def forward(self, samples: NestedTensor, image_ids: list):
        ...
        hs, memory = self.detr.transformer(self.detr.input_proj(c5), mask, self.detr.query_embed.weight, pos[-1], semantic_features=None, semantic_masks=None)
        ...
        interaction_hs = self.interaction_transformer(self.detr.input_proj(c5), mask, self.query_embed.weight, pos[-1], semantic_features=semantic_features, semantic_masks=semantic_masks)[0] # interaction representations
        # [HO Pointers]
